...
function initialState() {
    ...
    document.querySelector("#personal-info .c-accordion__content").style.display = "none";
    document.querySelector("#personal-info .c-accordion__submit").classList.add("c-accordion__submit--hidden");
}
...
function editInfoAccount() {
    ...
    document.querySelector("#personal-info .c-accordion__content").style.display = "none";
    document.querySelector("#account-info").classList.add("c-accordion__item--active-leftborder");
    document.querySelector("#personal-info").classList.remove("c-accordion__item--active-leftborder");
    document.querySelector("#account-info .c-accordion__circle").classList.add("c-accordion__circle--active-circle");
    document.querySelector("#personal-info .c-accordion__circle").classList.remove("c-accordion__circle--active-circle");
    document.querySelector("#account-info .c-accordion__circle").classList.remove("c-accordion__circle--valid");
    document.querySelector("#account-info .c-accordion__circle i").classList.remove("fa-solid", "fa-check", "fa-xs");
}
...
function goNextFormularSection() {
    ...
    if(isPasswdValid(passwd)) {
        showSummarySection();
        document.querySelector("#personal-info .c-accordion__content").style.display = "block";
        document.querySelector("#account-info .c-accordion__content").classList.add("c-accordion__content--hidden");
        document.querySelector("#personal-info .c-accordion__submit").classList.remove("c-accordion__submit--hidden");
        document.querySelector("#account-info").classList.remove("c-accordion__item--active-leftborder");
        document.querySelector("#personal-info").classList.add("c-accordion__item--active-leftborder");
        document.querySelector("#account-info .c-accordion__circle").classList.remove("c-accordion__circle--active-circle");
        document.querySelector("#personal-info .c-accordion__circle").classList.add("c-accordion__circle--active-circle");
        document.querySelector("#account-info .c-accordion__circle").classList.add("c-accordion__circle--valid");
        document.querySelector("#account-info .c-accordion__circle i").classList.add("fa-solid", "fa-check", "fa-xs");
    }
}
